            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-6 relative">
                ...
                <div>
                  ...
                  <a 
                    href="https://lin.ee/gdcz1XC" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-block bg-[#06C755] hover:bg-[#05b54d] text-white px-6 py-2 rounded font-bold text-sm transition-colors"
                  >
                    友だち追加する
                  </a>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  土:11:00 - 18:00 (完全予約制)<br/>
                  日:9:00 - 18:00 (完全予約制)<br/>
                  ※夜間施工は要相談
                </p>
              </div>
